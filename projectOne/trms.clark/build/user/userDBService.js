                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.doc
                                ...
                                .catch(function (err) {
                                log_1.default.error('GetUserByName err: ' + err);
                                return null;
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        log_1.default.debug("addUser: " + user_1.userToString(user));
                        return [4 /*yield*/, this.doc
                                .put(params)
                                .promise()
                                .then(function () {
                                log_1.default.info('Successfully created Employee');
                                return true;
                            })
                                .catch(function (error) {
                                log_1.default.error("addUser: " + error);
                                return false;
                            })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
                ...
                switch (_a.label) {
                    case 0:
                        params = {
                            ...
                            UpdateExpression: 'set #availableAmount=:availableAmount, #claimReqsToApprove=:claimReqsToApprove, #claimReqs=:claimReqs',
                            ExpressionAttributeValues: {
                        ...
                        return [4 /*yield*/, this.doc
                                ...
                                .promise()
                                .then(function (data) {
                                log_1.default.debug("Data: " + JSON.stringify(data));
                                return true;
                            })
                                .catch(function (error) {
                                log_1.default.error("updateUser: " + error);
                                return false;
                            })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
